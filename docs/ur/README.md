...
* **Localization**: Localization means that the translated text needs to be adapted to the to the local language, customs and localization standards. For example, in many cases you would need to use Urdu names rather than English, e.g. Edward — Hamid, New York — Islamabad. Do not translate every word, but use the style that is natural for Urdu.
